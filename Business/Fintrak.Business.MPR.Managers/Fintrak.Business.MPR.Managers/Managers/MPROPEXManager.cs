...
namespace Fintrak.Business.MPR.Managers
{
    ...
    public class MPROPEXManager : ManagerBase, IMPROPEXService
    {
        ...
        public CostCentreDefinition UpdateCostCentreDefinition(CostCentreDefinition costCentreDefinition)
        {
            ...
            {
                var groupNames = new List<string>() { GROUP_ADMINISTRATOR, GROUP_USER, GROUP_USER_ADMINISTRATOR };
                ...
                foreach (var costCentreInfo in costCentreInfos)
                {
                    costCentre.Add(
                        new CostCentreData
                        {
                            ...
                            Year = costCentreInfo.CostCentre.Year,
        ...
        #region OpexGLBasis2 operations
        ...
        public OpexGLBasis2 UpdateOpexGLBasis2(OpexGLBasis2 opexglbasis2)
        {
            return ExecuteFaultHandledOperation(() =>
            {
                ...
                IOpexGLBasis2Repository opexRepository = _DataRepositoryFactory.GetDataRepository<IOpexGLBasis2Repository>();

                OpexGLBasis2 updatedEntity = null;

                if (opexglbasis2.ID == 0)
                {
                    updatedEntity = opexRepository.Add(opexglbasis2);
                }
                else
                    updatedEntity = opexRepository.Update(opexglbasis2);
        ...
        public OpexGLBasis2 GetOpexGLBasis2(int ID)
        {
            return ExecuteFaultHandledOperation(() =>
            {
                ...
                OpexGLBasis2 opexEntity = opexRepository.Get(ID);
                if (opexEntity == null)
                {
                    NotFoundException ex = new NotFoundException(string.Format("OpexGLBasis with ID of {0} is not in database", ID));
                    throw new FaultException<NotFoundException>(ex, ex.Message);
                }
        ...
        public OpexGLBasis2[] GetAllOpexGLBasis2()
        {
            return ExecuteFaultHandledOperation(() =>
            {
                ...
                IEnumerable<OpexGLBasis2> opex = opexRepository.Get().ToArray();
        ...
        #region OpexStaffcostDetail operations
        ...
        public OpexStaffcostDetail UpdateOpexStaffcostDetail(OpexStaffcostDetail opexStaffcostDetail)
        {
            return ExecuteFaultHandledOperation(() =>
            {
                ...
                IOpexStaffcostDetailRepository opexRepository = _DataRepositoryFactory.GetDataRepository<IOpexStaffcostDetailRepository>();

                OpexStaffcostDetail updatedEntity = null;

                if (opexStaffcostDetail.ID == 0)
                {
                    updatedEntity = opexRepository.Add(opexStaffcostDetail);
                }
                else
                    updatedEntity = opexRepository.Update(opexStaffcostDetail);
        ...
        public OpexStaffcostDetail GetOpexStaffcostDetail(int ID)
        {
            return ExecuteFaultHandledOperation(() =>
            {
                ...
                OpexStaffcostDetail opexEntity = opexRepository.Get(ID);
                if (opexEntity == null)
                {
                    NotFoundException ex = new NotFoundException(string.Format("OpexStaffcostDetail with ID of {0} is not in database", ID));
                    throw new FaultException<NotFoundException>(ex, ex.Message);
                }
        ...
        public OpexStaffcostDetail[] GetAllOpexStaffcostDetail()
        {
            return ExecuteFaultHandledOperation(() =>
            {
                ...
                IEnumerable<OpexStaffcostDetail> opex = opexRepository.Get().ToArray();
        ...
        #region OpexTimeAllocationMPR operations
        ...
        public OpexTimeAllocationMPR UpdateOpexTimeAllocationMPR(OpexTimeAllocationMPR opexTimeAllocationMPR)
        {
            return ExecuteFaultHandledOperation(() =>
            {
                ...
                IOpexTimeAllocationMPRRepository opexRepository = _DataRepositoryFactory.GetDataRepository<IOpexTimeAllocationMPRRepository>();

                OpexTimeAllocationMPR updatedEntity = null;

                if (opexTimeAllocationMPR.ID == 0)
                {
                    updatedEntity = opexRepository.Add(opexTimeAllocationMPR);
                }
                else
                    updatedEntity = opexRepository.Update(opexTimeAllocationMPR);
        ...
        public OpexTimeAllocationMPR GetOpexTimeAllocationMPR(int ID)
        {
            return ExecuteFaultHandledOperation(() =>
            {
                ...
                OpexTimeAllocationMPR opexEntity = opexRepository.Get(ID);
                if (opexEntity == null)
                {
                    NotFoundException ex = new NotFoundException(string.Format("OpexTimeAllocationMPR with ID of {0} is not in database", ID));
                    throw new FaultException<NotFoundException>(ex, ex.Message);
                }
        ...
        public OpexTimeAllocationMPR[] GetAllOpexTimeAllocationMPR()
        {
            return ExecuteFaultHandledOperation(() =>
            {
                ...
                IEnumerable<OpexTimeAllocationMPR> opex = opexRepository.Get().ToArray();
        ...
        #region IncomeProductShare operations
        ...
        public IncomeProductShare UpdateIncomeProductShare(IncomeProductShare incomeProductShare)
        {
            return ExecuteFaultHandledOperation(() =>
            {
                ...
                IIncomeProductShareRepository opexRepository = _DataRepositoryFactory.GetDataRepository<IIncomeProductShareRepository>();

                IncomeProductShare updatedEntity = null;

                if (incomeProductShare.ID == 0)
                {
                    updatedEntity = opexRepository.Add(incomeProductShare);
                }
                else
                    updatedEntity = opexRepository.Update(incomeProductShare);
        ...
        public IncomeProductShare GetIncomeProductShare(int ID)
        {
            return ExecuteFaultHandledOperation(() =>
            {
                ...
                IncomeProductShare opexEntity = opexRepository.Get(ID);
                if (opexEntity == null)
                {
                    NotFoundException ex = new NotFoundException(string.Format("IncomeProductShare with ID of {0} is not in database", ID));
                    throw new FaultException<NotFoundException>(ex, ex.Message);
                }
        ...
        public IncomeProductShare[] GetAllIncomeProductShare()
        {
            return ExecuteFaultHandledOperation(() =>
            {
                ...
                IEnumerable<IncomeProductShare> opex = opexRepository.Get().ToArray();
        ...
        #region OpexMaintenance operations
        ...
        public OpexMaintenance UpdateOpexMaintenance(OpexMaintenance opexMaintenance)
        {
            return ExecuteFaultHandledOperation(() =>
            {
                ...
                IOpexMaintenanceRepository opexRepository = _DataRepositoryFactory.GetDataRepository<IOpexMaintenanceRepository>();

                OpexMaintenance updatedEntity = null;

                if (opexMaintenance.ID == 0)
                {
                    updatedEntity = opexRepository.Add(opexMaintenance);
                }
                else
                    updatedEntity = opexRepository.Update(opexMaintenance);
        ...
        public OpexMaintenance GetOpexMaintenance(int ID)
        {
            return ExecuteFaultHandledOperation(() =>
            {
                ...
                OpexMaintenance opexEntity = opexRepository.Get(ID);
                if (opexEntity == null)
                {
                    NotFoundException ex = new NotFoundException(string.Format("OpexMaintenance with ID of {0} is not in database", ID));
                    throw new FaultException<NotFoundException>(ex, ex.Message);
                }
        ...
        public OpexMaintenance[] GetAllOpexMaintenance()
        {
            return ExecuteFaultHandledOperation(() =>
            {
                ...
                IEnumerable<OpexMaintenance> opex = opexRepository.Get().ToArray();
        ...
        #region OpexMemounits operations
        ...
        public OpexMemounits UpdateOpexMemounits(OpexMemounits opexMemounits)
        {
            return ExecuteFaultHandledOperation(() =>
            {
                ...
                IOpexMemounitsRepository opexRepository = _DataRepositoryFactory.GetDataRepository<IOpexMemounitsRepository>();

                OpexMemounits updatedEntity = null;

                if (opexMemounits.ID == 0)
                {
                    updatedEntity = opexRepository.Add(opexMemounits);
                }
                else
                    updatedEntity = opexRepository.Update(opexMemounits);
        ...
        public OpexMemounits GetOpexMemounits(int ID)
        {
            return ExecuteFaultHandledOperation(() =>
            {
                ...
                OpexMemounits opexEntity = opexRepository.Get(ID);
                if (opexEntity == null)
                {
                    NotFoundException ex = new NotFoundException(string.Format("OpexMemounits with ID of {0} is not in database", ID));
                    throw new FaultException<NotFoundException>(ex, ex.Message);
                }
        ...
        public OpexMemounits[] GetAllOpexMemounits()
        {
            return ExecuteFaultHandledOperation(() =>
            {
                ...
                IEnumerable<OpexMemounits> opex = opexRepository.Get().ToArray();
        ...
        #region OpexMemounitPlmap operations
        ...
        public OpexMemounitPlmap UpdateOpexMemounitPlmap(OpexMemounitPlmap opexMemounitPlmap)
        {
            return ExecuteFaultHandledOperation(() =>
            {
                ...
                IOpexMemounitPlmapRepository opexRepository = _DataRepositoryFactory.GetDataRepository<IOpexMemounitPlmapRepository>();

                OpexMemounitPlmap updatedEntity = null;

                if (opexMemounitPlmap.ID == 0)
                {
                    updatedEntity = opexRepository.Add(opexMemounitPlmap);
                }
                else
                    updatedEntity = opexRepository.Update(opexMemounitPlmap);
        ...
        public OpexMemounitPlmap GetOpexMemounitPlmap(int ID)
        {
            return ExecuteFaultHandledOperation(() =>
            {
                ...
                OpexMemounitPlmap opexEntity = opexRepository.Get(ID);
                if (opexEntity == null)
                {
                    NotFoundException ex = new NotFoundException(string.Format("OpexMemounitPlmap with ID of {0} is not in database", ID));
                    throw new FaultException<NotFoundException>(ex, ex.Message);
                }
        ...
        public OpexMemounitPlmap[] GetAllOpexMemounitPlmap()
        {
            return ExecuteFaultHandledOperation(() =>
            {
                ...
                IEnumerable<OpexMemounitPlmap> opex = opexRepository.Get().ToArray();
        ...
        #region OpexSBUBaseCost operations
        ...
        public OpexSBUBaseCost UpdateOpexSBUBaseCost(OpexSBUBaseCost opexSBUBaseCost)
        {
            return ExecuteFaultHandledOperation(() =>
            {
                ...
                IOpexSBUBaseCostRepository opexRepository = _DataRepositoryFactory.GetDataRepository<IOpexSBUBaseCostRepository>();

                OpexSBUBaseCost updatedEntity = null;

                if (opexSBUBaseCost.ID == 0)
                {
                    updatedEntity = opexRepository.Add(opexSBUBaseCost);
                }
                else
                    updatedEntity = opexRepository.Update(opexSBUBaseCost);
        ...
        public OpexSBUBaseCost GetOpexSBUBaseCost(int ID)
        {
            return ExecuteFaultHandledOperation(() =>
            {
                ...
                OpexSBUBaseCost opexEntity = opexRepository.Get(ID);
                if (opexEntity == null)
                {
                    NotFoundException ex = new NotFoundException(string.Format("OpexSBUBaseCost with ID of {0} is not in database", ID));
                    throw new FaultException<NotFoundException>(ex, ex.Message);
                }
        ...
        public OpexSBUBaseCost[] GetAllOpexSBUBaseCost()
        {
            return ExecuteFaultHandledOperation(() =>
            {
                ...
                IEnumerable<OpexSBUBaseCost> opex = opexRepository.Get().ToArray();
        ...
        public OpexUpdate UpdateOpexUpdate(OpexUpdate opexUpdate)
        {
            return ExecuteFaultHandledOperation(() =>
            {
                ...
                IOpexUpdateRepository opexRepository = _DataRepositoryFactory.GetDataRepository<IOpexUpdateRepository>();

                OpexUpdate updatedEntity = null;

                if (opexUpdate.ID == 0)
                {
                    updatedEntity = opexRepository.Add(opexUpdate);
                }
                else
                    updatedEntity = opexRepository.Update(opexUpdate);
        ...
        public OpexUpdate GetOpexUpdate(int ID)
        {
            return ExecuteFaultHandledOperation(() =>
            {
                ...
                OpexUpdate opexEntity = opexRepository.Get(ID);
                if (opexEntity == null)
                {
                    NotFoundException ex = new NotFoundException(string.Format("OpexUpdate with ID of {0} is not in database", ID));
                    throw new FaultException<NotFoundException>(ex, ex.Message);
                }
        ...
        public OpexUpdate[] GetAllOpexUpdate()
        {
            return ExecuteFaultHandledOperation(() =>
            {
                ...
                IEnumerable<OpexUpdate> opex = opexRepository.Get().ToArray();
        ...
        public OpexGLMap UpdateOpexGLMap(OpexGLMap op)
        {
            return ExecuteFaultHandledOperation(() =>
            {
                ...
                IOpexGLMapRepository opexRepository = _DataRepositoryFactory.GetDataRepository<IOpexGLMapRepository>();

                OpexGLMap updatedEntity = null;

                if (op.Id == 0)
                {
                    updatedEntity = opexRepository.Add(op);
                }
                else
                    updatedEntity = opexRepository.Update(op);
        ...
        public OpexGLMap GetOpexGLMap(int Id)
        {
            return ExecuteFaultHandledOperation(() =>
            {
                ...
                OpexGLMap opexEntity = opexRepository.Get(Id);
                if (opexEntity == null)
                {
                    NotFoundException ex = new NotFoundException(string.Format("data with ID of {0} is not in database", Id));
                    throw new FaultException<NotFoundException>(ex, ex.Message);
                }
        ...
        public OpexGLMap[] GetAllOpexGLMap()
        {
            return ExecuteFaultHandledOperation(() =>
            {
                ...
                IEnumerable<OpexGLMap> opex = opexRepository.Get().ToArray();
