...
namespace Fintrak.Business.MPR.Contracts
{
    ...
    public interface IMPROPEXService : IServiceContract
    {
        ...
        [OperationContract]
        [TransactionFlow(TransactionFlowOption.Allowed)]
        OpexGLBasis2 UpdateOpexGLBasis2(OpexGLBasis2 opexglbasis2);

        [OperationContract]
        [TransactionFlow(TransactionFlowOption.Allowed)]
        void DeleteOpexGLBasis2(int ID);

        [OperationContract]
        [FaultContract(typeof(NotFoundException))]
        OpexGLBasis2 GetOpexGLBasis2(int ID);

        [OperationContract]
        OpexGLBasis2[] GetAllOpexGLBasis2();
        ...
        [OperationContract]
        [TransactionFlow(TransactionFlowOption.Allowed)]
        OpexStaffcostDetail UpdateOpexStaffcostDetail(OpexStaffcostDetail opexStaffcostDetail);

        [OperationContract]
        [TransactionFlow(TransactionFlowOption.Allowed)]
        void DeleteOpexStaffcostDetail(int ID);

        [OperationContract]
        [FaultContract(typeof(NotFoundException))]
        OpexStaffcostDetail GetOpexStaffcostDetail(int ID);

        [OperationContract]
        OpexStaffcostDetail[] GetAllOpexStaffcostDetail();
        ...
        [OperationContract]
        [TransactionFlow(TransactionFlowOption.Allowed)]
        OpexTimeAllocationMPR UpdateOpexTimeAllocationMPR(OpexTimeAllocationMPR opexTimeAllocationMPR);

        [OperationContract]
        [TransactionFlow(TransactionFlowOption.Allowed)]
        void DeleteOpexTimeAllocationMPR(int ID);

        [OperationContract]
        [FaultContract(typeof(NotFoundException))]
        OpexTimeAllocationMPR GetOpexTimeAllocationMPR(int ID);

        [OperationContract]
        OpexTimeAllocationMPR[] GetAllOpexTimeAllocationMPR();
        ...
        [OperationContract]
        [TransactionFlow(TransactionFlowOption.Allowed)]
        IncomeProductShare UpdateIncomeProductShare(IncomeProductShare incomeProductShare);

        [OperationContract]
        [TransactionFlow(TransactionFlowOption.Allowed)]
        void DeleteIncomeProductShare(int ID);

        [OperationContract]
        [FaultContract(typeof(NotFoundException))]
        IncomeProductShare GetIncomeProductShare(int ID);

        [OperationContract]
        IncomeProductShare[] GetAllIncomeProductShare();
        ...
        [OperationContract]
        [TransactionFlow(TransactionFlowOption.Allowed)]
        OpexMaintenance UpdateOpexMaintenance(OpexMaintenance opexMaintenance);

        [OperationContract]
        [TransactionFlow(TransactionFlowOption.Allowed)]
        void DeleteOpexMaintenance(int ID);

        [OperationContract]
        [FaultContract(typeof(NotFoundException))]
        OpexMaintenance GetOpexMaintenance(int ID);

        [OperationContract]
        OpexMaintenance[] GetAllOpexMaintenance();
        ...
        [OperationContract]
        [TransactionFlow(TransactionFlowOption.Allowed)]
        OpexMemounits UpdateOpexMemounits(OpexMemounits opexMemounits);

        [OperationContract]
        [TransactionFlow(TransactionFlowOption.Allowed)]
        void DeleteOpexMemounits(int ID);

        [OperationContract]
        [FaultContract(typeof(NotFoundException))]
        OpexMemounits GetOpexMemounits(int ID);

        [OperationContract]
        OpexMemounits[] GetAllOpexMemounits();
        ...
        [OperationContract]
        [TransactionFlow(TransactionFlowOption.Allowed)]
        OpexMemounitPlmap UpdateOpexMemounitPlmap(OpexMemounitPlmap opexMemounitPlmap);

        [OperationContract]
        [TransactionFlow(TransactionFlowOption.Allowed)]
        void DeleteOpexMemounitPlmap(int ID);

        [OperationContract]
        [FaultContract(typeof(NotFoundException))]
        OpexMemounitPlmap GetOpexMemounitPlmap(int ID);

        [OperationContract]
        OpexMemounitPlmap[] GetAllOpexMemounitPlmap();
        ...
        [OperationContract]
        [TransactionFlow(TransactionFlowOption.Allowed)]
        OpexSBUBaseCost UpdateOpexSBUBaseCost(OpexSBUBaseCost opexSBUBaseCost);

        [OperationContract]
        [TransactionFlow(TransactionFlowOption.Allowed)]
        void DeleteOpexSBUBaseCost(int ID);

        [OperationContract]
        [FaultContract(typeof(NotFoundException))]
        OpexSBUBaseCost GetOpexSBUBaseCost(int ID);

        [OperationContract]
        OpexSBUBaseCost[] GetAllOpexSBUBaseCost();
        ...
        [OperationContract]
        [TransactionFlow(TransactionFlowOption.Allowed)]
        OpexUpdate UpdateOpexUpdate(OpexUpdate opexUpdate);

        [OperationContract]
        [TransactionFlow(TransactionFlowOption.Allowed)]
        void DeleteOpexUpdate(int ID);

        [OperationContract]
        [FaultContract(typeof(NotFoundException))]
        OpexUpdate GetOpexUpdate(int ID);

        [OperationContract]
        OpexUpdate[] GetAllOpexUpdate();
        ...
        [OperationContract]
        [TransactionFlow(TransactionFlowOption.Allowed)]
        OpexGLMap UpdateOpexGLMap(OpexGLMap opexUpdate);

        [OperationContract]
        [TransactionFlow(TransactionFlowOption.Allowed)]
        void DeleteOpexGLMap(int Id);

        [OperationContract]
        [FaultContract(typeof(NotFoundException))]
        OpexGLMap GetOpexGLMap(int Id);

        [OperationContract]
        OpexGLMap[] GetAllOpexGLMap();
