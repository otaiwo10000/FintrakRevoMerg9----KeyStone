...
namespace Fintrak.Business.SystemCore.Managers
{
    ...
    public class CoreManager : ManagerBase, ICoreService
    {
        ...
        public Solution GetSolution(int solutionId)
        {
            return ExecuteFaultHandledOperation(() =>
            {
                var groupNames = new List<string>() { SystemCoreModuleDefinition.GROUP_ADMINISTRATOR, SystemCoreModuleDefinition.GROUP_SUPER_BUSINESS, SystemCoreModuleDefinition.GROUP_BUSINESS, SystemCoreModuleDefinition.GROUP_USER, SystemCoreModuleDefinition.GROUP_ACCESS };
                AllowAccessToOperation(SystemCoreModuleDefinition.SOLUTION_NAME, groupNames);
        ...
        public Solution[] GetAllSolutions()
        {
            return ExecuteFaultHandledOperation(() =>
            {
                var groupNames = new List<string>() { SystemCoreModuleDefinition.GROUP_ADMINISTRATOR, SystemCoreModuleDefinition.GROUP_BUSINESS, SystemCoreModuleDefinition.GROUP_SUPER_BUSINESS, SystemCoreModuleDefinition.GROUP_USER, SystemCoreModuleDefinition.GROUP_ACCESS };
                AllowAccessToOperation(SystemCoreModuleDefinition.SOLUTION_NAME, groupNames);
        ...
        public UserSetup UpdateUserSetup(UserSetup userSetup)
        {
            return ExecuteFaultHandledOperation(() =>
            {
                var groupNames = new List<string>() { SystemCoreModuleDefinition.GROUP_ADMINISTRATOR, SystemCoreModuleDefinition.GROUP_SUPER_BUSINESS, SystemCoreModuleDefinition.GROUP_ACCESS };
                AllowAccessToOperation(SystemCoreModuleDefinition.SOLUTION_NAME, groupNames);
