...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("AcquirerMappingListController",
                    ['$scope', '$state', 'viewModelHelper', 'validator',
                        AcquirerMappingListController]);

    function AcquirerMappingListController($scope, $state, viewModelHelper, validator) {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;

        vm.module = 'MPR Core ';
        vm.view = 'acquirermapping-list-view';
        vm.viewName = 'Acquirer Mapping';
        ...
        var InitialGrid = function () {
            setTimeout(function () {
                ...
                // data export
                if ($('#acquirermappingTable').length > 0) {
                    var exportTable = $('#acquirermappingTable').DataTable({
