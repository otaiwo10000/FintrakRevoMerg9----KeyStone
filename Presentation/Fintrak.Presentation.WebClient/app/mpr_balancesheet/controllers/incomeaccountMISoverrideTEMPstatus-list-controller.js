...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("IncomeAccountMISOverrideTEMPStatusListController",
            ['$scope', '$window', '$state', 'viewModelHelper', 'validator',
                IncomeAccountMISOverrideTEMPStatusListController]);

    function IncomeAccountMISOverrideTEMPStatusListController($scope, $window, $state, viewModelHelper, validator) {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;

        vm.module = 'mpr';
        vm.view = 'incomeaccountMISoverrideTEMPstatus-list-view';
        vm.viewName = 'Income Account MIS Override status';
        ...
        vm.obuLoad = function () {
            ...
            vm.awaitingstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/incomeaccountMISoverrideTEMPstatus/incomeaccountMISoverrideusingparamsAWAITING/' + vm.searchvalue1, null,
                    function (result) {
        ...
        var initialize2 = function () {
            ...
            if (vm.init2 === false) {
                vm.viewModelHelper.apiGet('api/incomeaccountMISoverrideTEMPstatus/incomeaccountMISoverrideAPPROVED', null,
                    function (result) {
                        //vm.onboardingusers = result.data;
        ...
        vm.obuLoad2 = function () {
            ...
            vm.approvedstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/incomeaccountMISoverrideTEMPstatus/incomeaccountMISoverrideusingparamsAPPROVED/' + vm.searchvalue2, null,
                    function (result) {
        ...
        var initialize3 = function () {
            ...
            if (vm.init3 === false) {
                vm.viewModelHelper.apiGet('api/incomeaccountMISoverrideTEMPstatus/incomeaccountMISoverrideDECLINED', null,
                    function (result) {
                        //vm.onboardingusers = result.data;
        ...
        vm.obuLoad3 = function () {
            ...
            vm.declinedstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/incomeaccountMISoverrideTEMPstatus/incomeaccountMISoverrideusingparamsDECLINED/' + vm.searchvalue3, null,
                    function (result) {
        ...
        vm.approve = function () {
            ...
            if (approveFlag) {
                ...
                vm.viewModelHelper.apiPost('api/incomeaccountMISoverrideTEMPstatus/incomeaccountMISoverrideapproval', vm.selectionoverride,
                        function (result) {
        ...
        vm.decline = function () {
            ...
            if (declinedFlag) {
               ...
               // url = 'api/incomeaccountMISoverrideTEMPstatus/incomeaccountMISoverridedecline/' + vm.selectedId,
                    //vm.viewModelHelper.apiPost(url, null,
                vm.viewModelHelper.apiPost('api/incomeaccountMISoverrideTEMPstatus/incomeaccountMISoverridedecline', vm.selectionoverride,
                        function (result) {
