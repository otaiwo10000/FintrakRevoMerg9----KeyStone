...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("IncomeRetailProductOverrideTEMPStatusListController",
            ['$scope', '$window', '$state', 'viewModelHelper', 'validator',
                IncomeRetailProductOverrideTEMPStatusListController]);

    function IncomeRetailProductOverrideTEMPStatusListController($scope, $window, $state, viewModelHelper, validator) {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;

        vm.module = 'mpr';
        vm.view = 'incomeretailproductoverrideTEMPstatus-list-view';
        vm.viewName = 'Income Retail Product Override status';
        ...
        var initialize = function () {
            ...
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/incomeretailproductoverrideTEMPstatus/incomeretailproductoverrideAWAITING', null,
                    function (result) {
        ...
        vm.obuLoad = function () {
            ...
            vm.awaitingstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/incomeretailproductoverrideTEMPstatus/incomeretailproductoverrideusingparamsAWAITING/' + vm.searchvalue1, null,
                    function (result) {
        ...
        var initialize2 = function () {
            ...
            if (vm.init2 === false) {
                vm.viewModelHelper.apiGet('api/incomeretailproductoverrideTEMPstatus/incomeretailproductoverrideAPPROVED', null,
                    function (result) {
                        //vm.onboardingusers = result.data;
        ...
        vm.obuLoad2 = function () {
            ...
            vm.approvedstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/incomeretailproductoverrideTEMPstatus/incomeretailproductoverrideusingparamsAPPROVED/' + vm.searchvalue2, null,
                    function (result) {
        ...
        var initialize3 = function () {
            ...
            if (vm.init3 === false) {
                vm.viewModelHelper.apiGet('api/incomeretailproductoverrideTEMPstatus/incomeretailproductoverrideDECLINED', null,
                    function (result) {
                        //vm.onboardingusers = result.data;
        ...
        vm.obuLoad3 = function () {
            ...
            vm.declinedstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/incomeretailproductoverrideTEMPstatus/incomeretailproductoverrideusingparamsDECLINED/' + vm.searchvalue3, null,
                    function (result) {
        ...
        vm.toggleTextAccountRetailProd = "check all";
        vm.checkallboxes = false;

        var toggleTextRetailProdFunc = function () {
            if (vm.checkallboxes === false) {
                vm.toggleTextAccountRetailProd = "uncheck all";
            }
        ...
        vm.RetailProdAllCheckBoxes = function () {

            toggleTextRetailProdFunc();
        ...
        vm.approve = function () {
            ...
            if (approveFlag) {
                //var url = '';
                //url = 'api/incomeretailproductoverrideTEMPstatus/incomeretailproductoverrideapproval/' + vm.selectedId,
                    //vm.viewModelHelper.apiPost(url, null,
                vm.viewModelHelper.apiPost('api/incomeretailproductoverrideTEMPstatus/incomeretailproductoverrideapproval', vm.selectionoverride,
                        function (result) {
                            toastr.success('Selected item approved.', 'Fintrak');
                            $state.go('mpr-incomeretailproductoverrideTEMPstatus-list');
                            vm.refreshOBU();
                            vm.refreshOBU2();
                            vm.refreshOBU3();
                        },
        ...
        vm.decline = function () {
            ...
            if (declinedFlag) {
                //var url = '';
                //url = 'api/incomeretailproductoverrideTEMPstatus/incomeretailproductoverridedecline/' + vm.selectedId,
                    //vm.viewModelHelper.apiPost(url, null,
                vm.viewModelHelper.apiPost('api/incomeretailproductoverrideTEMPstatus/incomeretailproductoverridedecline', vm.selectionoverride,
                        function (result) {
