...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("IncomeAccountsListingTEMPStatusListController",
            ['$scope', '$window', '$state', 'viewModelHelper', 'validator',
                IncomeAccountsListingTEMPStatusListController]);

    function IncomeAccountsListingTEMPStatusListController($scope, $window, $state, viewModelHelper, validator) {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;

        vm.module = 'mpr';
        vm.view = 'incomeaccountslistingTEMPstatus-list-view';
        vm.viewName = 'Income Accounts Listing status';
        ...
        var initialize = function () {
            ...
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/incomeaccountslistingTEMPstatus/incomeaccountslistingAWAITING', null,
                    function (result) {
        ...
        vm.obuLoad = function () {
            ...
            vm.awaitingstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/incomeaccountslistingTEMPstatus/incomeaccountslistingusingparamsAWAITING/' + vm.searchvalue1, null,
                    function (result) {
        ...
        var initialize2 = function () {
            ...
            if (vm.init2 === false) {
                vm.viewModelHelper.apiGet('api/incomeaccountslistingTEMPstatus/incomeaccountslistingAPPROVED', null,
                    function (result) {
                        //vm.onboardingusers = result.data;
        ...
        vm.obuLoad2 = function () {
            ...
            vm.approvedstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/incomeaccountslistingTEMPstatus/incomeaccountslistingusingparamsAPPROVED/' + vm.searchvalue2, null,
                    function (result) {
        ...
        var initialize3 = function () {
            ...
            if (vm.init3 === false) {
                vm.viewModelHelper.apiGet('api/incomeaccountslistingTEMPstatus/incomeaccountslistingDECLINED', null,
                    function (result) {
                        //vm.onboardingusers = result.data;
        ...
        vm.obuLoad3 = function () {
            ...
            vm.declinedstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/incomeaccountslistingTEMPstatus/incomeaccountslistingusingparamsDECLINED/' + vm.searchvalue3, null,
                    function (result) {
        ...
        vm.toggleTextIncomeAccountsListing = "check all";
        vm.checkallboxes = false;

        var toggleTextIncomeAccountsListingFunc = function () {
            if (vm.checkallboxes === false) {
                vm.toggleTextIncomeAccountsListing = "uncheck all";
            }
        ...
        vm.IncomeAccountsListingAllCheckBoxes = function () {

            toggleTextIncomeAccountsListingFunc();
        ...
        vm.approve = function () {
            ...
            if (approveFlag) {
                vm.viewModelHelper.apiPost('api/incomeaccountslistingTEMPstatus/incomeaccountslistingapproval', vm.selectionoverride,
                        function (result) {
                            toastr.success('Selected item approved.', 'Fintrak');
                            vm.selectionoverride = [];
                            vm.selectedId = '';
                            $state.go('mpr-incomeaccountslistingTEMPstatus-list');
                            vm.refreshOBU();
                            vm.refreshOBU2();
                            vm.refreshOBU3();
                        },
        ...
        vm.decline = function () {
            ...
            if (declinedFlag) {
               ...
               // url = 'api/incomeaccountMISoverrideTEMPstatus/incomeaccountMISoverridedecline/' + vm.selectedId,
                ...
                vm.viewModelHelper.apiPost('api/incomeaccountslistingTEMPstatus/incomeaccountslistingdecline', vm.selectionoverride,
                        function (result) {
