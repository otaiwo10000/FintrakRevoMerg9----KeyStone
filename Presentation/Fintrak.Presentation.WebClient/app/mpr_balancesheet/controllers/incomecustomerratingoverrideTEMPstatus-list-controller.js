...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("IncomeCustomerRatingOverrideTEMPStatusListController",
            ['$scope', '$window', '$state', 'viewModelHelper', 'validator',
                IncomeCustomerRatingOverrideTEMPStatusListController]);

    function IncomeCustomerRatingOverrideTEMPStatusListController($scope, $window, $state, viewModelHelper, validator) {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;

        vm.module = 'mpr';
        vm.view = 'incomecustomerratingoverrideTEMPstatus-list-view';
        vm.viewName = 'Income Customer Override Rating';
...
//=================================== awaiting approval starts =========================================================================
        ...
        var initialize = function () {
            ...
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/incomecustomerratingoverrideTEMPstatus/incomecustomerratingoverrideAWAITING', null,
                    function (result) {
        ...
        vm.obuLoad = function () {
            ...
            vm.awaitingstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/incomecustomerratingoverrideTEMPstatus/incomecustomerratingoverrideusingparamsAWAITING/' + vm.searchvalue1, null,
                    function (result) {
...
//=================================== approved starts =========================================================================
        ...
        var initialize2 = function () {
            ...
            if (vm.init2 === false) {
                vm.viewModelHelper.apiGet('api/incomecustomerratingoverrideTEMPstatus/incomecustomerratingoverrideAPPROVED', null,
                    function (result) {
                        //vm.onboardingusers = result.data;
        ...
        vm.obuLoad2 = function () {
            ...
            vm.approvedstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/incomecustomerratingoverrideTEMPstatus/incomecustomerratingoverrideusingparamsAPPROVED/' + vm.searchvalue2, null,
                    function (result) {
...
//=================================== declined starts =========================================================================
        ...
        var initialize3 = function () {
            ...
            if (vm.init3 === false) {
                vm.viewModelHelper.apiGet('api/incomecustomerratingoverrideTEMPstatus/incomecustomerratingoverrideDECLINED', null,
                    function (result) {
                        //vm.onboardingusers = result.data;
        ...
        vm.obuLoad3 = function () {
            ...
            vm.declinedstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/incomecustomerratingoverrideTEMPstatus/incomecustomerratingoverrideusingparamsDECLINED/' + vm.searchvalue3, null,
                    function (result) {
...
//=================================== declined ends =========================================================================
        ...
        vm.toggleTextCustomerRating = "check all";
        vm.checkallboxes = false;

        var toggleTextCustomerRatingFunc = function () {
            if (vm.checkallboxes === false) {
                vm.toggleTextCustomerRating = "uncheck all";
            }
        ...
        //$scope.RetailProdAllCheckBoxes = function () {
        vm.CustomerRatingAllCheckBoxes = function () {

            toggleTextCustomerRatingFunc();
        ...
        vm.approve = function () {           
            ...
            if (approveFlag) {
                //var url = '';
                //url = 'api/incomecustomerratingoverrideTEMPstatus/incomecustomerratingoverrideapproval/' + vm.selectedId,
                    //vm.viewModelHelper.apiPost(url, null,
                vm.viewModelHelper.apiPost('api/incomecustomerratingoverrideTEMPstatus/incomecustomerratingoverrideapproval', vm.selectionoverride,
                        function (result) {
                            toastr.success('Selected item approved.', 'Fintrak');
                            vm.selectionoverride = [];
                            vm.selectedId = '';
                            $state.go('mpr-incomecustomerratingoverrideTEMPstatus-list');
                            vm.refreshOBU();
                            vm.refreshOBU2();
                            vm.refreshOBU3();
                        },
        ...
        vm.decline = function () {
            ...
            if (declinedFlag) {
                //var url = '';
                //url = 'api/incomecustomerratingoverrideTEMPstatus/incomecustomerratingoverridedecline/' + vm.selectedId,
                    //vm.viewModelHelper.apiPost(url, null,
                vm.viewModelHelper.apiPost('api/incomecustomerratingoverrideTEMPstatus/incomecustomerratingoverridedecline', vm.selectionoverride,
                        function (result) {
