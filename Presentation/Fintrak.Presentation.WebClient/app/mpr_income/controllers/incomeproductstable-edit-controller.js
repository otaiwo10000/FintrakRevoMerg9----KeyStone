...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("IncomeProductsTableEditController",
            ['$scope', '$window', '$state', '$stateParams', 'viewModelHelper', 'validator', '$location',
                IncomeProductsTableEditController]);

    function IncomeProductsTableEditController($scope, $window, $state, $stateParams, viewModelHelper, validator) {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;

        vm.module = 'MPR Core';
        vm.view = 'incomeproductstable-edit-view';
        ...
        vm.aprstatusList = [{ Value: ' ', Name: ' ' }, { Value: 'Y', Name: 'Y' }, { Value: 'N', Name: 'N' }]
        ...
        var initialize = function () {
            if (vm.init === false) {
                ...
                if ($stateParams.ProductId !== 0) {
                    ...
                    vm.viewModelHelper.apiGet('api/incomeproductstable/getincomeproduct/' + $stateParams.ProductId, null,
                        function (result) {
                            vm.clist = true;
                            vm.ipt = result.data;
                ...
                vm.ipt = {
                    ...
                    GCapPosition: '', SubTotal_item: '', GroupCode: '', SubGroupCode: '',
                    ProductType: '', ReplicationCaption: '', DeductionCaption: '', RetailCaption: '',
                    Del_Flg: '', Product_SUPERCAPTION: '', Active: true
                };
            }
        }
        ...
        vm.save = function () {
            ...
            if (vm.viewModelHelper.modelIsValid) {
                ...
                vm.viewModelHelper.apiPost('api/incomeproductstable/updateincomeproduct', vm.ipt,
                    function (result) {

                        $state.go('mpr-incomeproductstable-list');
                    },
                    function (result) {
                        toastr.error(result.data, 'Fintrak');
                    }, null);
        ...
        vm.delete = function () {
            ...
            if (deleteFlag) {
                vm.viewModelHelper.apiPost('api/incomeproductstable/deleteincomeproduct', vm.ipt.ProductId,
                    function (result) {
