...
(function () {
    ...
    function MonthlyDiscountFactorPlacementListController($scope,$state,$window, viewModelHelper, validator) {
        ...
        vm.viewName = 'Monthly Discount Factor Placements';
        ...
        var InitialGrid = function () {
            setTimeout(function () {
                ...
                // data export
                if ($('#monthlydiscountfactorplacementTable1').length > 0) {
                    var exportTable = $('#monthlydiscountfactorplacementTable1').DataTable({
