...
(function () {
    ...
    function CollateralRealizationPeriodEditController($scope,$window, $state, $stateParams, viewModelHelper, validator) {
        ...
        var setupRules = function () {
            ...
            collateralrealizationperiodRules.push(new validator.PropertyRule("ProductCode", {
                required: { message: "Product is required" }
            }));

            collateralrealizationperiodRules.push(new validator.PropertyRule("collateralTypeCode", {
                required: { message: "Schedule Type is required" }
            }));
            collateralrealizationperiodRules.push(new validator.PropertyRule("MarketRate", {
                required: { message: "Market Rate is required" }
            }));
            collateralrealizationperiodRules.push(new validator.PropertyRule("PastDueRate", {
        ...
        vm.delete = function () {
            ...
            if (deleteFlag) {
                vm.viewModelHelper.apiPost('api/collateralrealizationperiod/deletecollateralrealizationperiod', vm.collateralRealizationPeriod.ProductId,
              function (result) {
