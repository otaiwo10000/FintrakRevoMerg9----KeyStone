...
(function () {
    ...
    function LoanPryListController($scope,$state, viewModelHelper, validator) {
        ...
        var initialize = function(){
            ...
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/loanPry/availableloanPry', null,
                   function (result) {
        ...
        var InitialGrid = function () {
          ...
          //    vm.viewModelHelper.apiGet('api/loanPry/getloanPry/' + vm.classification, null,
          //              function (result) {
          //                  vm.loanPry = result.data;
          //                                },
          //             function (result) {
          //                 toastr.error('Fail to load LoanPry data', 'Fintrak Error');
          //             }, null);
          //      }
