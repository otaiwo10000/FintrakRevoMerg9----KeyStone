...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("IncomeNewDetailsTEMPStatusListController",
            ['$scope', '$window', '$state', 'viewModelHelper', 'validator',
                IncomeNewDetailsTEMPStatusListController]);

    function IncomeNewDetailsTEMPStatusListController($scope, $window, $state, viewModelHelper, validator) {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;

        vm.module = 'mpr';
        vm.view = 'incomenewdetailsTEMPstatusListController-list-view';
        vm.viewName = 'IncomeNewDetails Status';
        ...
        var initialize = function () {
            ...
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/incomenewdetailsTEMPstatus/incomenewdetailsTEMPawaiting', null,
                    function (result) {
        ...
        vm.obuLoad = function () {
            ...
            vm.awaitingstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/incomenewdetailsTEMPstatus/incomenewdetailsTEMPusingparamsawaiting/' + vm.searchvalue1, null,
                    function (result) {
        ...
        var initialize2 = function () {
            ...
            if (vm.init2 === false) {
                vm.viewModelHelper.apiGet('api/incomenewdetailsTEMPstatus/incomenewdetailsTEMPapproved', null,
                    function (result) {
                        //vm.onboardingusers = result.data;
        ...
        vm.obuLoad2 = function () {
            ...
            vm.approvedstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/incomenewdetailsTEMPstatus/incomenewdetailsTEMPusingparamsapproved/' + vm.searchvalue2, null,
                    function (result) {
        ...
        var initialize3 = function () {
            ...
            if (vm.init3 === false) {
                vm.viewModelHelper.apiGet('api/incomenewdetailsTEMPstatus/incomenewdetailsTEMPdeclined', null,
                    function (result) {
                        //vm.onboardingusers = result.data;
        ...
        vm.obuLoad3 = function () {
            ...
            vm.declinedstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/incomenewdetailsTEMPstatus/incomenewdetailsTEMPusingparamsdeclined/' + vm.searchvalue3, null,
                    function (result) {
        ...
        var toggleTextIncomeNewDetailsFunc = function () {
            if (vm.checkallboxes === false) {
                vm.toggleTextIncomeNewDetails= "uncheck all";
            }
        ...
        vm.IncomeNewDetailsAllCheckBoxes = function () {

            toggleTextIncomeNewDetailsFunc();
        ...
        vm.approve = function () {
            ...
            if (approveFlag) {
                vm.viewModelHelper.apiPost('api/incomenewdetailsTEMPstatus/incomenewdetailsTEMPapproval', vm.selectionoverride,
                    function (result) {
        ...
        vm.decline = function () {
            ...
            if (declinedFlag) {
                vm.viewModelHelper.apiPost('api/incomenewdetailsTEMPstatus/incomenewdetailsTEMPdecline', vm.selectionoverride,
                    function (result) {
