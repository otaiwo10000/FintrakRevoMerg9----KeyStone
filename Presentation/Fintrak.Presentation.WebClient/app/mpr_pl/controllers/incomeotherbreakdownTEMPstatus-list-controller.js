...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("IncomeOtherBreakdownTEMPStatusListController",
            ['$scope', '$window', '$state', 'viewModelHelper', 'validator',
                IncomeOtherBreakdownTEMPStatusListController]);

    function IncomeOtherBreakdownTEMPStatusListController($scope, $window, $state, viewModelHelper, validator) {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;

        vm.module = 'mpr';
        vm.view = 'incomeotherbreakdownTEMPstatusListController-list-view';
        vm.viewName = 'IncomeOtherBreakdown Status';
        ...
        var initialize = function () {
            ...
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/incomeotherbreakdownTEMPstatus/incomeotherbreakdownTEMPawaiting', null,
                    function (result) {
        ...
        vm.obuLoad = function () {
            ...
            vm.awaitingstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/incomeotherbreakdownTEMPstatus/incomeotherbreakdownTEMPusingparamsawaiting/' + vm.searchvalue1, null,
                    function (result) {
        ...
        var initialize2 = function () {
            ...
            if (vm.init2 === false) {
                vm.viewModelHelper.apiGet('api/incomeotherbreakdownTEMPstatus/incomeotherbreakdownTEMPapproved', null,
                    function (result) {
                        //vm.onboardingusers = result.data;
        ...
        vm.obuLoad2 = function () {
            ...
            vm.approvedstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/incomeotherbreakdownTEMPstatus/incomeotherbreakdownTEMPusingparamsapproved/' + vm.searchvalue2, null,
                    function (result) {
        ...
        var initialize3 = function () {
            ...
            if (vm.init3 === false) {
                vm.viewModelHelper.apiGet('api/incomeotherbreakdownTEMPstatus/incomeotherbreakdownTEMPdeclined', null,
                    function (result) {
                        //vm.onboardingusers = result.data;
        ...
        vm.obuLoad3 = function () {
            ...
            vm.declinedstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/incomeotherbreakdownTEMPstatus/incomeotherbreakdownTEMPusingparamsdeclined/' + vm.searchvalue3, null,
                    function (result) {
        ...
        vm.toggleTextIncomeOtherBreakdown = "check all";
        vm.checkallboxes = false;

        var toggleTextIncomeOtherBreakdownFunc = function () {
            if (vm.checkallboxes === false) {
                vm.toggleTextIncomeOtherBreakdown = "uncheck all";
            }
            else if (vm.checkallboxes === true) {
                vm.toggleTextIncomeNewDetails = "check all";
            }
        };

        vm.IncomeOtherBreakdownAllCheckBoxes = function () {

            toggleTextIncomeOtherBreakdownFunc();
        ...
        vm.approve = function () {
            ...
            if (approveFlag) {
                vm.viewModelHelper.apiPost('api/incomeotherbreakdownTEMPstatus/incomeotherbreakdownTEMPapproval', vm.selectionoverride,
                    function (result) {
        ...
        vm.decline = function () {
            ...
            if (declinedFlag) {
                vm.viewModelHelper.apiPost('api/incomeotherbreakdownTEMPstatus/incomeotherbreakdownTEMPdecline', vm.selectionoverride,
                    function (result) {
