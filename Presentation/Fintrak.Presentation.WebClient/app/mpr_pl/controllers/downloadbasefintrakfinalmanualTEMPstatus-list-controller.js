...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("DownLoadBaseFintrakFinalManualTEMPstatusListController",
            ['$scope', '$window', '$state', 'viewModelHelper', 'validator',
                DownLoadBaseFintrakFinalManualTEMPstatusListController]);

    function DownLoadBaseFintrakFinalManualTEMPstatusListController($scope, $window, $state, viewModelHelper, validator) {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;

        vm.module = 'mpr';
        vm.view = 'downloadbasefintrakfinalmanualTEMPstatus-list-view';
        vm.viewName = 'Downloadbase FintrakFinal Manual status';
        ...
        var initialize = function () {
            ...
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/downloadbasefintrakfinalmanualTEMPstatus/downloadbasefintrakfinalmanualTEMPawaiting', null,
                    function (result) {
        ...
        vm.obuLoad = function () {
            ...
            vm.awaitingstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/downloadbasefintrakfinalmanualTEMPstatus/downloadbasefintrakfinalmanualTEMPusingparamsawaiting/' + vm.searchvalue1, null,
                    function (result) {
        ...
        var initialize2 = function () {
            ...
            if (vm.init2 === false) {
                vm.viewModelHelper.apiGet('api/downloadbasefintrakfinalmanualTEMPstatus/downloadbasefintrakfinalmanualTEMPapproved', null,
                    function (result) {
                        //vm.onboardingusers = result.data;
        ...
        vm.obuLoad2 = function () {
            ...
            vm.approvedstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/downloadbasefintrakfinalmanualTEMPstatus/downloadbasefintrakfinalmanualTEMPusingparamsapproved/' + vm.searchvalue2, null,
                    function (result) {
        ...
        var initialize3 = function () {
            ...
            if (vm.init3 === false) {
                vm.viewModelHelper.apiGet('api/downloadbasefintrakfinalmanualTEMPstatus/downloadbasefintrakfinalmanualTEMPdeclined', null,
                    function (result) {
                        //vm.onboardingusers = result.data;
        ...
        vm.obuLoad3 = function () {
            ...
            vm.declinedstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/downloadbasefintrakfinalmanualTEMPstatus/downloadbasefintrakfinalmanualTEMPusingparamsdeclined/' + vm.searchvalue3, null,
                    function (result) {
        ...
        vm.toggleTextDownloadBaseFintrakFinalManual = "check all";
        vm.checkallboxes = false;

        var toggleTextDownloadBaseFintrakFinalManualFunc = function () {
            if (vm.checkallboxes === false) {
                vm.toggleTextDownloadBaseFintrakFinalManual = "uncheck all";
            }
        ...
        vm.DownloadBaseFintrakFinalManualAllCheckBoxes = function () {

            toggleTextDownloadBaseFintrakFinalManualFunc();
        ...
        vm.approve = function () {
            ...
            if (approveFlag) {
                vm.viewModelHelper.apiPost('api/downloadbasefintrakfinalmanualTEMPstatus/downloadbasefintrakfinalmanualTEMPapproval', vm.selectionoverride,
                    function (result) {
        ...
        vm.decline = function () {
            ...
            if (declinedFlag) {
                vm.viewModelHelper.apiPost('api/downloadbasefintrakfinalmanualTEMPstatus/downloadbasefintrakfinalmanualTEMPdecline', vm.selectionoverride,
                    function (result) {
