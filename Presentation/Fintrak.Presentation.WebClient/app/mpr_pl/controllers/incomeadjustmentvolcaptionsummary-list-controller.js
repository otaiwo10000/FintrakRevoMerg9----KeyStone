...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("IncomeAdjustmentVolCaptionSummaryListController",
                    ['$scope', '$state', 'viewModelHelper', 'validator',
                        IncomeAdjustmentVolCaptionSummaryListController]);

    function IncomeAdjustmentVolCaptionSummaryListController($scope, $state, viewModelHelper, validator)  {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;

        vm.module = 'MPR PL';
        vm.view = 'incomeadjustmentvolcaptionsummary-list-view';
        vm.viewName = 'Segment Caption Summary';
        ...
        var initialize = function () {
            ...
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/incomeadjustmentsummary/volcaptionsummary/' + vm.period + '/' + vm.year + '/' + vm.search, null,

                    function (result) {
                        vm.volcaptionsummary = result.data;
        ...
        var InitialGrid = function () {
            setTimeout(function () {
                ...
                // data export
                if ($('#vcsummaryTable').length > 0) {
                    var exportTable = $('#vcsummaryTable').DataTable({
        ...
        vm.volcaptionsummaryLoad = function () {
            ...
            vm.viewModelHelper.apiGet('api/incomeadjustmentsummary/volcaptionsummary/' + vm.period + '/' + vm.year + '/' + vm.search2a, null,
