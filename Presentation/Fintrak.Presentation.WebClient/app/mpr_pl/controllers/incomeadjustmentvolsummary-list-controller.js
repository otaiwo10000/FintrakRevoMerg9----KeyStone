...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("IncomeAdjustmentVolSummaryListController",
                    ['$scope', '$state', 'viewModelHelper', 'validator',
                        IncomeAdjustmentVolSummaryListController]);

    function IncomeAdjustmentVolSummaryListController($scope, $state, viewModelHelper, validator)  {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;

        vm.module = 'MPR PL';
        vm.view = 'incomeadjustmentvolsummary-list-view';
        vm.viewName = 'Adjustment Volume Summary';
