...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("IncomeAdjustmentCommFeeSBUCaptionSummaryListController",
                    ['$scope', '$state', 'viewModelHelper', 'validator',
                        IncomeAdjustmentCommFeeSBUCaptionSummaryListController]);

    function IncomeAdjustmentCommFeeSBUCaptionSummaryListController($scope, $state, viewModelHelper, validator)  {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;

        vm.module = 'MPR PL';
        vm.view = 'incomeadjustmentcommfeeSBUcaptionsummary-list-view';
        vm.viewName = 'CommFee Adjustment SBU Caption Summary';
        ...
        var initialize = function () {
            ...
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/incomeadjustmentsummary/commfeesbucaptionsummary/' + vm.period + '/' + vm.year + '/' + vm.search, null,

                    function (result) {
                        vm.cfsbuList = result.data;
        ...
        vm.summaryLoad = function () {
            ...
            vm.viewModelHelper.apiGet('api/incomeadjustmentsummary/commfeesbucaptionsummary/' + vm.period + '/' + vm.year + '/' + vm.search2a, null,
