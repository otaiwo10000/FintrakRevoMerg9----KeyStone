...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("IncomeAdjustmentCommFeeCaptionSummaryListController",
                    ['$scope', '$state', 'viewModelHelper', 'validator',
                        IncomeAdjustmentCommFeeCaptionSummaryListController]);

    function IncomeAdjustmentCommFeeCaptionSummaryListController($scope, $state, viewModelHelper, validator)  {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;

        vm.module = 'MPR PL';
        vm.view = 'incomeadjustmentcommfeecaptionsummary-list-view';
        vm.viewName = 'CommFee Segment Caption Summary';
        ...
        var initialize = function () {
            ...
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/incomeadjustmentsummary/commfeecaptionsummary/' + vm.period + '/' + vm.year + '/' + vm.search, null,
