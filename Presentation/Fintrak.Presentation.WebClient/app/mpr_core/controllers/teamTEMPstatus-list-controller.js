...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("TeamTEMPStatusListController",
            ['$scope', '$window', '$state', 'viewModelHelper', 'validator',
                TeamTEMPStatusListController]);

    function TeamTEMPStatusListController($scope, $window, $state, viewModelHelper, validator) {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;

        vm.module = 'mpr';
        vm.view = 'teamTEMPstatus-list-view';
        vm.viewName = 'Team status';
...
//=================================== awaiting approval starts =========================================================================
        ...
        var initialize = function () {
            ...
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/teamTEMPstatus/teamTEMPstatusAWAITING', null,
                    function (result) {
        ...
        vm.obuLoad = function () {
            ...
            vm.awaitingstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/teamTEMPstatus/teamTEMPstatususingparamsAWAITING/' + vm.searchvalue1, null,
                    function (result) {
...
//=================================== approved starts =========================================================================
        ...
        var initialize2 = function () {
            ...
            if (vm.init2 === false) {
                vm.viewModelHelper.apiGet('api/teamTEMPstatus/teamTEMPstatusAPPROVED', null,
                    function (result) {
                        //vm.onboardingusers = result.data;
        ...
        vm.obuLoad2 = function () {
            ...
            vm.approvedstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/teamTEMPstatus/teamTEMPstatususingparamsAPPROVED/' + vm.searchvalue2, null,
                    function (result) {
...
//=================================== declined starts =========================================================================
        ...
        var initialize3 = function () {
            ...
            if (vm.init3 === false) {
                vm.viewModelHelper.apiGet('api/teamTEMPstatus/teamTEMPstatusDECLINED', null,
                    function (result) {
                        //vm.onboardingusers = result.data;
        ...
        vm.obuLoad3 = function () {
            ...
            vm.declinedstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/teamTEMPstatus/teamTEMPstatususingparamsDECLINED/' + vm.searchvalue3, null,
                    function (result) {
...
//=================================== declined ends =========================================================================
        ...
        vm.toggleTextTeam = "check all";
        vm.checkallboxes = false;

        var toggleTextTeamFunc = function () {
            if (vm.checkallboxes === false) {
                vm.toggleTextTeam = "uncheck all";
            }
        ...
        vm.TeamAllCheckBoxes = function () {
            ...
            if (vm.checkallboxes === true) {
                angular.forEach(vm.awaitingstatus, function (a, b) {
                    ...
                    vm.selectedId = vm.selectionoverride.push(a.Team_StructureId);
                    //vm.selectedId = $scope.selectionoverride.join(', ');
                    vm.selectedId = vm.selectionoverride.join(', ');
                });
            }
        ...
        vm.approve = function () {           
            ...
            if (approveFlag) {
                ...
                vm.viewModelHelper.apiPost('api/teamTEMPstatus/teamTEMPapproval', vm.selectionoverride,
                        function (result) {
        ...
        vm.decline = function () {
            ...
            if (declinedFlag) {
                ...
                //    vm.viewModelHelper.apiPost(url, null,
                vm.viewModelHelper.apiPost('api/teamTEMPstatus/teamTEMPdecline', vm.selectionoverride,
                        function (result) {
