...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("IncomeAccountsTreeAccountTEMPStatusListController",
            ['$scope', '$window', '$state', 'viewModelHelper', 'validator',
                IncomeAccountsTreeAccountTEMPStatusListController]);

    function IncomeAccountsTreeAccountTEMPStatusListController($scope, $window, $state, viewModelHelper, validator) {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;

        vm.module = 'mpr';
        vm.view = 'incomeaccountstreeaccountTEMPstatus-list-view';
        vm.viewName = 'Income Account Tree status';
        ...
        var initialize = function () {
            ...
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/incomeaccountstreeaccounttemp/incomeaccountstreeaccountAWAITING', null,
                    function (result) {
        ...
        vm.obuLoad = function () {
            ...
            vm.awaitingstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/incomeaccountstreeaccounttemp/incomeaccountstreeaccountusingparamsAWAITING/' + vm.searchvalue1, null,
                    function (result) {
        ...
        var initialize2 = function () {
            ...
            if (vm.init2 === false) {
                vm.viewModelHelper.apiGet('api/incomeaccountstreeaccounttemp/incomeaccountstreeaccountAPPROVED', null,
                    function (result) {
                        //vm.onboardingusers = result.data;
        ...
        vm.obuLoad2 = function () {
            ...
            vm.approvedstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/incomeaccountstreeaccounttemp/incomeaccountstreeaccountusingparamsAPPROVED/' + vm.searchvalue2, null,
                    function (result) {
        ...
        var initialize3 = function () {
            ...
            if (vm.init3 === false) {
                vm.viewModelHelper.apiGet('api/incomeaccountstreeaccounttemp/incomeaccountstreeaccountDECLINED', null,
                    function (result) {
                        //vm.onboardingusers = result.data;
        ...
        vm.obuLoad3 = function () {
            ...
            vm.declinedstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/incomeaccountstreeaccounttemp/incomeaccountstreeaccountusingparamsDECLINED/' + vm.searchvalue3, null,
                    function (result) {
        ...
        vm.toggleTextAccountTree = "check all";
        vm.checkallboxes = false;

        var toggleTextAccountsTreeFunc = function () {
            if (vm.checkallboxes === false) {
                vm.toggleTextAccountTree = "uncheck all";
            }
        ...
        //$scope.AccountTreeAllCheckBoxes = function () {
        vm.AccountTreeAllCheckBoxes = function () {

            toggleTextAccountsTreeFunc();
        ...
        vm.approve = function () {
            ...
            if (approveFlag) {
                //var url = '';
                //url = 'api/incomeaccountstreeaccounttemp/incomeaccountstreeaccountapproval/' + vm.selectedId,
                    //vm.viewModelHelper.apiPost(url, null,
                vm.viewModelHelper.apiPost('api/incomeaccountstreeaccounttemp/incomeaccountstreeaccountapproval', vm.selectionoverride,
                        function (result) {
        ...
        vm.decline = function () {
            ...
            if (declinedFlag) {
                //var url = '';
                //url = 'api/incomeaccountstreeaccounttemp/incomeaccountstreeaccountdecline/' + vm.selectedId,
                //    vm.viewModelHelper.apiPost(url, null,
                vm.viewModelHelper.apiPost('api/incomeaccountstreeaccounttemp/incomeaccountstreeaccountdecline', vm.selectionoverride,
                        function (result) {
