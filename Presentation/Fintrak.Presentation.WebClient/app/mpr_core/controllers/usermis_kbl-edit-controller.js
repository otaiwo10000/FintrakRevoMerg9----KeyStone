...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("UserMIS_KBLEditController",
                    ['$scope', '$window', '$state', '$stateParams', 'viewModelHelper', 'validator',
                        UserMIS_KBLEditController]);

    function UserMIS_KBLEditController($scope, $window, $state, $stateParams, viewModelHelper, validator) {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;

        vm.module = 'Core';
        vm.view = 'usermis_kbl-edit-view';
...
//===================== code that goes to mis code column starts =================================================
       ...
       // vm.userMIS.ProfitCenterDefinitionCode
        ...
        $scope.getSelectAllACCT = function (data) {
            var outpNew = "";
            angular.forEach(data, function (value, key) {
                //outpNew += value.AccountOfficer_Code + ",";
                outpNew += value.AccountOfficer_Code;
            });
            vm.userMIS.ProfitCenterMisCode = outpNew;
        };
        ...
        $scope.getSelectAllDIR = function (data) {
            var outpNew = "";
            angular.forEach(data, function (value, key) {
                //outpNew += value.Directorate_Code + ",";
                outpNew += value.Directorate_Code;
            });
            vm.userMIS.ProfitCenterMisCode = outpNew;
        };
...
//===================== code that goes to mis code column ends ===================================================
        ...
        vm.aofficer = function (code) {
            ...
            vm.viewModelHelper.apiGet('api/teamstructure/getteamstructureusingacctofficerKBL/' + code + '/' + vm.acctText, null,
                function (result) {
                    vm.ts = result.data;
                },
                function (result) {
