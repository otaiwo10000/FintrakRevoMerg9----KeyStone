...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("TeamStructureALLListController",
        ['$scope', '$state', 'viewModelHelper', 'validator', 'yearsService',
            TeamStructureALLListController]);

    function TeamStructureALLListController($scope, $state, viewModelHelper, validator, yearsService) {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;

        vm.module = 'MPR Core ';
        vm.view = 'teamstructureALL-list-view';
        vm.viewName = 'MPR TeamStructure';
        ...
        var initialize = function () {
            ...
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/teamstructureALL/getAllData', null,
                    function (result) {
                        vm.ts = result.data;
                        InitialView();
                        vm.init === true;
        ...
        vm.tsLoad = function () {
            ...
            if (vm.SearchValue === "") {
                ...
                if (vm.init === false) {
                    ...
                    vm.viewModelHelper.apiGet('api/teamstructureALL/teamstructureALLusingparameters/' + vm.selectedDefinitionCode + '/' + vm.SearchValue + '/' + vm.year, null,
                        function (result) {
