...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("SCMappingListController",
                    ['$scope', '$state', 'viewModelHelper', 'validator',
                        SCMappingListController]);

    function SCMappingListController($scope, $state, viewModelHelper, validator) {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;

        vm.module = 'MPR Core ';
        vm.view = 'scorecardmapping-list-view';
        ...
        var initialize = function () {
            ...
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/scorecardmapping/getscorecardmappingusingsetup', null,
                   function (result) {
                       vm.scm = result.data;
                       InitialView();
                       vm.init === true;
