...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("MISNewTEMPStatusListController",
            ['$scope', '$window', '$state', 'viewModelHelper', 'validator',
                MISNewTEMPStatusListController]);

    function MISNewTEMPStatusListController($scope, $window, $state, viewModelHelper, validator) {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;

        vm.module = 'mpr';
        vm.view = 'MISNewTEMPstatus-list-view';
        vm.viewName = 'Old and New Team status';
...
//=================================== awaiting approval starts =========================================================================
        ...
        var initialize = function () {
            ...
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/misnewTEMPstatus/misnewTEMPstatusAWAITING', null,
                    function (result) {
        ...
        vm.obuLoad = function () {
            ...
            vm.awaitingstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/misnewTEMPstatus/misnewTEMPstatususingparamsAWAITING/' + vm.searchvalue1, null,
                    function (result) {
...
//=================================== approved starts =========================================================================
        ...
        var initialize2 = function () {
            ...
            if (vm.init2 === false) {
                vm.viewModelHelper.apiGet('api/misnewTEMPstatus/misnewTEMPstatusAPPROVED', null,
                    function (result) {
                        //vm.onboardingusers = result.data;
        ...
        vm.obuLoad2 = function () {
            ...
            vm.approvedstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/misnewTEMPstatus/misnewTEMPstatususingparamsAPPROVED/' + vm.searchvalue2, null,
                    function (result) {
...
//=================================== declined starts =========================================================================
        ...
        var initialize3 = function () {
            ...
            if (vm.init3 === false) {
                vm.viewModelHelper.apiGet('api/misnewTEMPstatus/misnewTEMPstatusDECLINED', null,
                    function (result) {
                        //vm.onboardingusers = result.data;
        ...
        vm.obuLoad3 = function () {
            ...
            vm.declinedstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/misnewTEMPstatus/misnewTEMPstatususingparamsDECLINED/' + vm.searchvalue3, null,
                    function (result) {
...
//=================================== declined ends =========================================================================
        ...
        vm.toggleTextMISNew = "check all";
        vm.checkallboxes = false;

        var toggleTextMISNewFunc = function () {
            if (vm.checkallboxes === false) {
                vm.toggleTextMISNew = "uncheck all";
            }
        ...
        vm.MISNewAllCheckBoxes = function () {

            toggleTextMISNewFunc();
        ...
        vm.approve = function () {           
            ...
            if (approveFlag) {
                ...
                vm.viewModelHelper.apiPost('api/misnewTEMPstatus/misnewTEMPapproval', vm.selectionoverride,
                        function (result) {
        ...
        vm.decline = function () {
            ...
            if (declinedFlag) {
                ...
                //    vm.viewModelHelper.apiPost(url, null,
                vm.viewModelHelper.apiPost('api/misnewTEMPstatus/misnewTEMPdecline', vm.selectionoverride,
                        function (result) {
