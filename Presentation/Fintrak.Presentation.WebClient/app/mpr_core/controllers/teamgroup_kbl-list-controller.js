...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("TeamGroupKBLListController",
        ['$scope', '$window', '$state', 'viewModelHelper', 'validator', 'yearsService',
            TeamGroupKBLListController]);

    function TeamGroupKBLListController($scope, $window, $state, viewModelHelper, validator, yearsService) {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;

        vm.module = 'MPR Core';
        vm.view = 'teamgroup_kbl-list-view';
        ...
        var initialize = function () {
            ...
            if (vm.init === false) {
                yearFunc();
                vm.viewModelHelper.apiGet('api/teamstructurekbl/availableteamgroup', null,
                    function (result) {
