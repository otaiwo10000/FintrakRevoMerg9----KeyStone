...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("IncomeAccountsTreeMISCodesTEMPstatusListController",
            ['$scope', '$window', '$state', 'viewModelHelper', 'validator',
                IncomeAccountsTreeMISCodesTEMPstatusListController]);

    function IncomeAccountsTreeMISCodesTEMPstatusListController($scope, $window, $state, viewModelHelper, validator) {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;

        vm.module = 'mpr';
        vm.view = 'incomeaccountstreeMISCodesTEMPstatus-list-view';
        vm.viewName = 'Income Account Tree MIS Codes status';
        ...
        var initialize = function () {
            ...
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/incomeaccountstreemiscodestemp/incomeaccountstreemiscodesAWAITING', null,
                    function (result) {
        ...
        vm.obuLoad = function () {
            ...
            vm.awaitingstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/incomeaccountstreemiscodestemp/incomeaccountstreemiscodesusingparamsAWAITING/' + vm.searchvalue1, null,
                    function (result) {
        ...
        var initialize2 = function () {
            ...
            if (vm.init2 === false) {
                vm.viewModelHelper.apiGet('api/incomeaccountstreemiscodestemp/incomeaccountstreemiscodesAPPROVED', null,
                    function (result) {
                        //vm.onboardingusers = result.data;
        ...
        vm.obuLoad2 = function () {
            ...
            vm.approvedstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/incomeaccountstreemiscodestemp/incomeaccountstreemiscodesusingparamsAPPROVED/' + vm.searchvalue2, null,
                    function (result) {
        ...
        var initialize3 = function () {
            ...
            if (vm.init3 === false) {
                vm.viewModelHelper.apiGet('api/incomeaccountstreemiscodestemp/incomeaccountstreemiscodesDECLINED', null,
                    function (result) {
                        //vm.onboardingusers = result.data;
        ...
        vm.obuLoad3 = function () {
            ...
            vm.declinedstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/incomeaccountstreemiscodestemp/incomeaccountstreemiscodesusingparamsDECLINED/' + vm.searchvalue3, null,
                    function (result) {
        ...
        vm.toggleTextAccountTreeMISCode = "check all";
        vm.checkallboxes = false;

        var toggleTextAccountMISFunc = function () {
            if (vm.checkallboxes === false) {
                vm.toggleTextAccountTreeMISCode = "uncheck all";
            }
        ...
        vm.AccountTreeMISCodeAllCheckBoxes = function () {
        ...
        vm.approve = function () {
            ...
            if (approveFlag) {
                //var url = '';
                //url = 'api/incomeaccountstreemiscodestemp/incomeaccountstreemiscodesapproval/' + vm.selectedId,
                //    vm.viewModelHelper.apiPost(url, null,
                vm.viewModelHelper.apiPost('api/incomeaccountstreemiscodestemp/incomeaccountstreemiscodesapproval', vm.selectionoverride,
                        function (result) {
        ...
        vm.decline = function () {
            ...
            if (declinedFlag) {
                //var url = '';
                //url = 'api/incomeaccountstreemiscodestemp/incomeaccountstreemiscodesdecline/' + vm.selectedId,
                //    vm.viewModelHelper.apiPost(url, null,
                vm.viewModelHelper.apiPost('api/incomeaccountstreemiscodestemp/incomeaccountstreemiscodesdecline', vm.selectionoverride,
                        function (result) {
                            ...
                            vm.selectedId = '';
                            window.location.reload();
                            // $state.go('mpr-incomeaccountstreeMISCodesTEMPstatus-list');                          
                            // vm.refreshOBU();
                            // vm.refreshOBU2();
                            // vm.refreshOBU3();
                        },
