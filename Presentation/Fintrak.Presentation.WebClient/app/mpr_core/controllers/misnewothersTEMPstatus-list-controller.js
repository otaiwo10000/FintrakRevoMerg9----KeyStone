...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("MISNewOthersTEMPStatusListController",
            ['$scope', '$window', '$state', 'viewModelHelper', 'validator',
                MISNewOthersTEMPStatusListController]);

    function MISNewOthersTEMPStatusListController($scope, $window, $state, viewModelHelper, validator) {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;

        vm.module = 'mpr';
        vm.view = 'MISNewOthersTEMPstatus-list-view';
        vm.viewName = 'Old and New Accountofficer status';
...
//=================================== awaiting approval starts =========================================================================
        ...
        var initialize = function () {
            ...
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/misnewothersTEMPstatus/misnewothersTEMPstatusAWAITING', null,
                    function (result) {
        ...
        vm.obuLoad = function () {
            ...
            vm.awaitingstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/misnewothersTEMPstatus/misnewothersTEMPstatususingparamsAWAITING/' + vm.searchvalue1, null,
                    function (result) {
...
//=================================== approved starts =========================================================================
        ...
        var initialize2 = function () {
            ...
            if (vm.init2 === false) {
                vm.viewModelHelper.apiGet('api/misnewothersTEMPstatus/misnewothersTEMPstatusAPPROVED', null,
                    function (result) {
                        //vm.onboardingusers = result.data;
        ...
        vm.obuLoad2 = function () {
            ...
            vm.approvedstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/misnewothersTEMPstatus/misnewothersTEMPstatususingparamsAPPROVED/' + vm.searchvalue2, null,
                    function (result) {
...
//=================================== declined starts =========================================================================
        ...
        var initialize3 = function () {
            ...
            if (vm.init3 === false) {
                vm.viewModelHelper.apiGet('api/misnewothersTEMPstatus/misnewothersTEMPstatusDECLINED', null,
                    function (result) {
                        //vm.onboardingusers = result.data;
        ...
        vm.obuLoad3 = function () {
            ...
            vm.declinedstatus = [];
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/misnewothersTEMPstatus/misnewothersTEMPstatususingparamsDECLINED/' + vm.searchvalue3, null,
                    function (result) {
...
//=================================== declined ends =========================================================================
        ...
        vm.toggleTextMISNewOthers = "check all";
        vm.checkallboxes = false;

        var toggleTextMISNewOthersFunc = function () {
            if (vm.checkallboxes === false) {
                vm.toggleTextMISNewOthers = "uncheck all";
            }
        ...
        vm.MISNewOthersAllCheckBoxes = function () {

            toggleTextMISNewOthersFunc();
        ...
        vm.approve = function () {           
            ...
            if (approveFlag) {
                //var url = '';
                //url = 'api/teamTEMPstatus/teamTEMPapproval/' + vm.selectedId,
                //    vm.viewModelHelper.apiPost(url, null,
                vm.viewModelHelper.apiPost('api/misnewothersTEMPstatus/misnewothersTEMPapproval', vm.selectionoverride,
                        function (result) {
                            toastr.success('Selected item approved.', 'Fintrak');
                            vm.selectionoverride = [];
                            vm.selectedId = '';
                            //$state.go('mpr-teamTEMPstatus-list');
                            //vm.refreshOBU();
                            //vm.refreshOBU2();
                            //vm.refreshOBU3();
                        },
        ...
        vm.decline = function () {
            ...
            if (declinedFlag) {
                //var url = '';
                //url = 'api/teamTEMPstatus/teamTEMPdecline/' + vm.selectedId,
                //    vm.viewModelHelper.apiPost(url, null,
                vm.viewModelHelper.apiPost('api/misnewothersTEMPstatus/misnewothersTEMPdecline', vm.selectionoverride,
                        function (result) {
