...
namespace Fintrak.Presentation.WebClient.API
{
    ...
    [RoutePrefix("api/groupcaptions")]
    [UsesDisposableService]
    public class GroupCaptionsApiController : ApiControllerBase
    {
        [ImportingConstructor]
        public GroupCaptionsApiController(IMPRIncomeService mprincomeService)
        {
        ...
        [HttpGet]
        [Route("getallgroupcaptions")]
        public HttpResponseMessage GetAllGroupCaptions(HttpRequestMessage request)
        {
            return GetHttpResponse(request, () =>
            {
                GroupCaptions[] groupCaptions = _MPRIncomeService.GetAllGroupCaptions();

                return request.CreateResponse<GroupCaptions[]>(HttpStatusCode.OK, groupCaptions);
            });
        }
