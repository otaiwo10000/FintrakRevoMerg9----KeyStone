...
namespace Fintrak.Presentation.WebClient.API
{
    ...
    [RoutePrefix("api/plcaption2")]
    [UsesDisposableService]
    public class PLCaption2ApiController : ApiControllerBase
    {
        [ImportingConstructor]
        public PLCaption2ApiController(IMPRIncomeService mprincomeService)
        {
        ...
        [HttpGet]
        [Route("getallplcaption2")]
        public HttpResponseMessage GetAllPLCaption2(HttpRequestMessage request)
        {
            return GetHttpResponse(request, () =>
            {
                PLCaption2[] plcaption2 = _MPRIncomeService.GetAllPLCaption2();

                return request.CreateResponse<PLCaption2[]>(HttpStatusCode.OK, plcaption2);
            });
        }
