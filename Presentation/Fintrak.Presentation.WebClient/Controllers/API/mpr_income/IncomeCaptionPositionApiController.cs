...
namespace Fintrak.Presentation.WebClient.API
{
    ...
    [RoutePrefix("api/incomecaptionposition")]
    [UsesDisposableService]
    public class IncomeCaptionPositionApiController : ApiControllerBase
    {
        [ImportingConstructor]
        public IncomeCaptionPositionApiController(IMPRIncomeService mprincomeService)
        {
        ...
        [HttpGet]
        [Route("getallincomecaptionposition")]
        public HttpResponseMessage GetAllPLCaption2(HttpRequestMessage request)
        {
            return GetHttpResponse(request, () =>
            {
                IncomeCaptionPosition[] incomecaption = _MPRIncomeService.GetAllIncomeCaptionPosition();

                return request.CreateResponse<IncomeCaptionPosition[]>(HttpStatusCode.OK, incomecaption);
            });
        }
