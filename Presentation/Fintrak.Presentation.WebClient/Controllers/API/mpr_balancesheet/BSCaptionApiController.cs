...
namespace Fintrak.Presentation.WebClient.API
{
    ...
    public class BSCaptionApiController : ApiControllerBase
    {
        ...
        public HttpResponseMessage GetAvailableBSCaptions(HttpRequestMessage request)
        {
            return GetHttpResponse(request, () =>
            {
                BSCaptionDataN[] bsCaptions = _MPRBSService.GetAllBSCaptionsN();

                return request.CreateResponse<BSCaptionDataN[]>(HttpStatusCode.OK, bsCaptions);
            });
        }

        [HttpGet]
        [Route("availablebscaptionss")]
        public HttpResponseMessage GetAvailableBSCaptionss(HttpRequestMessage request)
        {
            return GetHttpResponse(request, () =>
            {
