...
namespace Fintrak.Presentation.WebClient.API
{
    ...
    public class IFRSRegistryApiController : ApiControllerBase
    {
        ...
        [HttpGet]
        [Route("availableregistrys")]
        public HttpResponseMessage GetAvailableRegistries(HttpRequestMessage request)
        {
            return GetHttpResponse(request, () =>
            {
                IFRSRegistryData[] registrys = _IFRSCoreService.GetAllIFRSRegistries();
        ...
        public HttpResponseMessage GetMainCaptions(HttpRequestMessage request)
        {
            return GetHttpResponse(request, () =>
            {
                IFRSRegistryData[] registries = _IFRSCoreService.GetAllIFRSRegistries();
