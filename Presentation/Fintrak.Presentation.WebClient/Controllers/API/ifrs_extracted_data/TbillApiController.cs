...
namespace Fintrak.Presentation.WebClient.API
{
    ...
    public class ifrstbillApiController : ApiControllerBase
    {
        ...
        [HttpGet]
        [Route("getifrstbill/{classification}")]
        ...
        [HttpGet]
        [Route("gettbillbymatdate/{matureDate}")]
        public HttpResponseMessage GetTbillbyDate(HttpRequestMessage request, DateTime matureDate)
        {
            return GetHttpResponse(request, () =>
            {
                HttpResponseMessage response = null;

                IFRSTbills[] ifrstbill = _IFRSDataService.GetTbillsByMaturityDate(matureDate);
