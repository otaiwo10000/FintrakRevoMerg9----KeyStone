...
namespace Fintrak.Client.IFRS.Contracts
{
    ...
    public interface IFinstatService : IServiceContract
    {
        ...
        [OperationContract]
        PostingDetailData[] GetPostingDetailsByType(ReportType reportType);
        ...
        [OperationContract]
        TrialBalanceConsolidated[] GetAllTrialBalanceConsolidated();
        ...
        [OperationContract]
        TrialBalanceConsolidatedIFRS[] GetAllTrialBalanceConsolidatedIFRS();
