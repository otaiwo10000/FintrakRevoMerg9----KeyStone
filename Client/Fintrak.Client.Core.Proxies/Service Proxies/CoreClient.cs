...
namespace Fintrak.Client.Core.Proxies
{
    ...
    public class CoreClient : UserClientBase<ICoreService>, ICoreService
    {
        ...
        {
            return Channel.UpdateIncomeCRRSector(ics);
        }

        public void DeleteIncomeCRRSector(int Id)
        {
            Channel.DeleteIncomeCRRSector(Id);
        }

        public IncomeCRRSector GetIncomeCRRSector(int Id)
        {
            return Channel.GetIncomeCRRSector(Id);
        }

        public IncomeCRRSector[] GetAllIncomeCRRSector()
        {
            return Channel.GetAllIncomeCRRSector();
        }
        ...
        {
            return Channel.UpdateIncomeMonths(im);
        }

        public void DeleteIncomeMonths(int Id)
        {
            Channel.DeleteIncomeMonths(Id);
        }

        public IncomeMonths GetIncomeMonths(int Id)
        {
            return Channel.GetIncomeMonths(Id);
        }

        public IncomeMonths[] GetAllIncomeMonths()
        {
            return Channel.GetAllIncomeMonths();
        }
