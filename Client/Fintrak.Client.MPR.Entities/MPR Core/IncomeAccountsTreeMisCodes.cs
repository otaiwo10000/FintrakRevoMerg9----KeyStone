...
{
    public class IncomeAccountsTreeMisCodes : ObjectBase
    {
        int _ID;
        ...
        class IncomeAccountsTreeMisCodesValidator : AbstractValidator<IncomeAccountsTreeMisCodes>
        {
            public IncomeAccountsTreeMisCodesValidator()
            {
        ...
        {
            return new IncomeAccountsTreeMisCodesValidator();
        }
