...
namespace Fintrak.Data.Core
{
    public class CoreContext : DbContext
    {
        ...
        public DbSet<IncomeCRRSector> IncomeCRRSectorSet { get; set; }
        public DbSet<IncomeMonths> IncomeMonthsSet { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            //IncomeCRRSector
            modelBuilder.Entity<IncomeCRRSector>().HasKey<int>(e => e.ID).Ignore(e => e.EntityId);
            modelBuilder.Entity<IncomeCRRSector>().Property(c => c.RowVersion).IsRowVersion();
            modelBuilder.Entity<IncomeCRRSector>().ToTable("Income_CRR_Sector");

            //IncomeMonths
            modelBuilder.Entity<IncomeMonths>().HasKey<int>(e => e.ID).Ignore(e => e.EntityId);
            modelBuilder.Entity<IncomeMonths>().Property(c => c.RowVersion).IsRowVersion();
            modelBuilder.Entity<IncomeMonths>().ToTable("Income_Months");
