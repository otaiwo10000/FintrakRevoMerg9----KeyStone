...
namespace Fintrak.Data.MPR
{
    ...
    public class MPRBalanceSheetRepository : DataRepositoryBase<MPRBalanceSheet>, IMPRBalanceSheetRepository
    {
        ...
        //    if (clientcode == "CMB")
        //        return GetAllBalanceSheetBySearch_A(searchType, searchValue, number, fromDate);
        //    else
        //        return GetAllBalanceSheetBySearch_B(searchType, searchValue, number, fromDate);
        //}

        //public List<MPRBalanceSheet> GetAllBalanceSheetBySearch_A(string searchType, string searchValue, int number, DateTime fromDate)
        //{
        //    //var connectionString = ConfigurationManager.ConnectionStrings["FintrakDBConnection"].ConnectionString;
        //    var connectionString = MPRContext.GetDataConnection();
        ...
        //public List<MPRBalanceSheet> GetAllBalanceSheetBySearch_B(string searchType, string searchValue, int number, DateTime fromDate)
        //{
        //    //var connectionString = ConfigurationManager.ConnectionStrings["FintrakDBConnection"].ConnectionString;
        //    var connectionString = MPRContext.GetDataConnection();
