...
{
    public interface IIncomeProductsTableALTRepository : IDataRepository<IncomeProductsTableALT>
    {
        IEnumerable<IncomeProductsTableALT> GetIncomeProductBySearchValue(string searchvalue);
